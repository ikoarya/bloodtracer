...
<head>
    <meta charset="utf-8" />
    <title>Form Pendonor Lama</title>
            ...
            <div class="page-content">
                ...
                <div class="page-breadcrumbs">
                    <ul class="breadcrumb">
                        ...
                        <li>
                            <a href="#">Pendaftaran Donor Lama</a>
                        </li>
                ...
                <div class="page-header position-relative">
                    <div class="header-title">
                        <h1>
                            Form Pendaftaran Pendonor Lama
                    ...
                    <div class="header-buttons">
                        ...
                        <a class="refresh" id="refresh-toggler" href="daftarlama.html">
                                    ...
                                    <div class="widget radius-bordered">
                                        ...
                                        <div class="widget-body">
                                            <form id="registrationForm" method="post" class="form-horizontal" action="<?php echo base_url(); ?>datapendonor/daftar" 
                                                    ...
                                                    <div class="col-lg-6">
                                                        <div class="input-group">
                                                                ...
                                                                <span class="input-group-btn">
                                                                    <button class="btn btn-default shiny" type="button" onclick="cekkodedonor()">Cek Kode</button>
                                                                </span>
                                                            </div>
                                                    </div>
                                                ...
                                                <div class="form-group">
                                                    <label class="col-lg-3 control-label">Nomor Antrian</label>
                                                    <div class="col-lg-6">
                                                        <input type="text" class="form-control" name="nomor" id="nomor" value="" disabled="true" />
                                                    </div>
                                                </div>

                                                <div class="form-group">
                                                    <label class="col-lg-3 control-label">Donor Ke</label>
                                                    <div class="col-lg-6">
                                                        <input type="text" class="form-control" name="donorke" id="donorke" value="" disabled="true" />
                                                    </div>
                                                </div>

                                                <div class="form-group">
                                                    <label class="col-lg-3 control-label">Donor Terakhir</label>
                                                    <div class="col-lg-6">
                                                        <input type="text" class="form-control" name="terakhir" id="terakhir" value="" disabled="true" />
                                                    </div>
                                                </div>
